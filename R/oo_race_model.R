...
Driver <- R6::R6Class("Driver",
  ...
  private = list(
    ...
    car = NA,
    t_driver = 0,
    tire_params = tibble::tibble(compound = c("soft", "medium", "hard", "intermediate", "wet"),
                                  k1 = c(10, 5, 1, 1, 1),
...
Race <- R6::R6Class("Race",
  public = list(
    ...
    get_drivers = function(){
      drivers = tibble::tibble("name" = character(),
                               "number" = integer(),
                               "code" = character(),
                               "grid" = integer(),
      ...
      for(driver in private$drivers){
        d<-tibble::tibble("name" = driver$get_name(),
  ...
  private = list(
    ...
    do_lap = function(){
      ...
      laptimes <- tibble::tibble(driverName = character(),
                                 laptime = numeric(),
